...
import org.cytoscape.rsCy3App.internal.rs_Java_Proj2_src_copy.general.fileproc.FileArrayProvider1;
import org.cytoscape.rsCy3App.internal.rs_Java_Proj2_src_copy.general.strproc.LineSplit1;
import org.cytoscape.rsCy3App.internal.rs_Java_Proj2_src_copy.general.strproc.StrJoin1;

public class MetabPPIPanel extends JPanel implements CytoPanelComponent, ActionListener {

	public static final String NETWORKNAME       = "MetabPPI v1.10.3"; // new String("MetabPPI v1.10.2")
	...
	public void actionPerformed(ActionEvent e){
		...
		if (e.getActionCommand().equals(READFILEBUTTONSTR)){
			...
			Generate_sub_MetabPPI1_1 gen_sub_metabppi = new Generate_sub_MetabPPI1_1(rSB);
