...
import rsCy3App.rsMetabPPI1_9_1.internal.rs_Java_Proj2_src_copy.general.set.rsHashStringSet1;
import rsCy3App.rsMetabPPI1_9_1.internal.rs_Java_Proj2_src_copy.general.strproc.SumUpUntilAvail1;
...
public class SubgCreationTask extends AbstractTask {
	...
	public void run(final TaskMonitor taskMonitor) throws Exception {
		...
		if(targetNodeSet.isEmpty()){
			// JOptionPane.showMessageDialog(null, "No matching metabolite found.");
