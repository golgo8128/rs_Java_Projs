...
public final class Build_metabPPI1_3 {

	private static Build_metabPPI1_3 instance;	
	private static RegServiceBag1_3 rSB;
	private static CyNetwork gen_cynet;
	
	private Build_metabPPI1_3(){}; 
	
	public static synchronized Build_metabPPI1_3 getInstance(RegServiceBag1_3 rSB){
		if(instance == null){
			instance = new Build_metabPPI1_3();
			Build_metabPPI1_3.rSB = rSB;
		}
		else if(!rSB.equals(Build_metabPPI1_3.rSB)){
	...
	public static synchronized Build_metabPPI1_3 getInstance(){
		 if(instance == null){ 
