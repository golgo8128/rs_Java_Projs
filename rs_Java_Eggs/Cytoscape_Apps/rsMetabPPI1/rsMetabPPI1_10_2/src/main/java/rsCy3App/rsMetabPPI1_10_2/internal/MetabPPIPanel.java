...
import rsCy3App.rsMetabPPI1_10_2.internal.rs_Java_Proj2_src_copy.general.fileproc.FileArrayProvider1;
import rsCy3App.rsMetabPPI1_10_2.internal.rs_Java_Proj2_src_copy.general.strproc.LineSplit1;
import rsCy3App.rsMetabPPI1_10_2.internal.rs_Java_Proj2_src_copy.general.strproc.StrJoin1;

public class MetabPPIPanel extends JPanel implements CytoPanelComponent, ActionListener {

	public static final String NETWORKNAME       = "MetabPPI v1.10.2"; // new String("MetabPPI v1.10.2")
	...
	public void actionPerformed(ActionEvent e){
		...
		if (e.getActionCommand().equals(READFILEBUTTONSTR)){
			...
			Build_metabPPI1_3 build_metabPPI = Build_metabPPI1_3.getInstance(rSB);
			CyNetwork metabPPI_cynet = build_metabPPI.build_net();
			VizMap1_2 metabPPI_vizmap = VizMap1_2.getInstance(rSB);
