...
public class NewNetSelNodesAllEdges1_1 {
	...
	public NewNetSelNodesAllEdges1_1(RegServiceBag1_3 rSB){
		this.rSB = rSB;
	...
	public CyNetworkView CreateNewNetandView(CyNetwork src_cynet, List<CyNode> picknodes){
		
		HashSet<CyNode> picknodes_set = new HashSet<CyNode>(picknodes);
