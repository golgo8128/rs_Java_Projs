...
import rsCy3App.rsMetabPPI1_11_2.internal.rs_Java_Proj4_cp.general.fileproc.FileArrayProvider1;
import rsCy3App.rsMetabPPI1_11_2.internal.rs_Java_Proj4_cp.general.strproc.LineSplit1;
import rsCy3App.rsMetabPPI1_11_2.internal.rs_Java_Proj4_cp.general.strproc.StrJoin1;
...
public class MetabPPIPanel1_2 extends JPanel implements CytoPanelComponent, ActionListener, FocusListener {
	...
	public static final String initial_message
		= "Input HMDB numbers.\n" +
		  ...
		  "- Do not use this App for researches.\n" +
