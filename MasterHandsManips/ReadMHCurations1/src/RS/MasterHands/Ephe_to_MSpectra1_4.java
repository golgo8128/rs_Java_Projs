...
public class Ephe_to_MSpectra1_4 {

	public HashMap<Float, HashMap<Float, Integer>> mt_mz_to_intsty;
	public Set<Float> key_mzs;
	private SessionInfo sess;
	
	public Ephe_to_MSpectra1_4(MasterHands imh, AlignmentInfo iainfo, SessionInfo isess){
	...
	public RS_MassSpectra_simple1_7 <Float, Float, Integer, Integer, Integer, Integer>
		to_RS_MSS(){
		
		RS_MassSpectra_simple1_7<Float, Float, Integer, Integer, Integer, Integer> mss
